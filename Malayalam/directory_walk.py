...
result.write("ENGLISH" + "\t" + "GOOGLE" + "\t" + "MALAYALAM" + "\t" + "SCORE" + "\n")
...
for root, dirs, files in os.walk('/home/rnd/projects/ind_districts/ind_districts/malayalam'):
    links_mappings = {}
    ...
    if "english" in root:
        ...
        f = codecs.open("/home/rnd/projects/ind_districts/ind_districts/malayalam/" + district + "/hindi_links.txt")
        lines = f.readlines()
        for line in lines:
