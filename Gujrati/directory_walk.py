...
result.write("ENGLISH" + "\t" + "GOOGLE" + "\t" + "HINDI" + "\t" + "SCORE" + "\n")
...
for root, dirs, files in os.walk('/home/rnd/projects/ind_districts/ind_districts/telugu'):
    links_mappings = {}
    ...
    if "english" in root:
        ...
        f = codecs.open("/home/rnd/projects/ind_districts/ind_districts/telugu/" + district + "/hindi_links.txt")
        lines = f.readlines()
        for line in lines:
